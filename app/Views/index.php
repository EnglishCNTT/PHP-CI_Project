...
<body class="app_version" data-spy="scroll" data-target="#navbarApp" data-offset="98">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="app_iphone_01 wow slideInUp hidden-xs hidden-sm" data-wow-duration="1s" data-wow-delay="0.2s">
                    <img src="assets/user/assets/user/uploads/app_iphone_01.png" alt="" class="img-fluid">
                </div>
                <div class="app_iphone_02 wow slideInUp hidden-xs hidden-sm" data-wow-duration="1s" data-wow-delay="0.5s">
                    <img src="assets/user/assets/user/uploads/app_iphone_02.png" alt="" class="img-fluid">
                </div>
            </div><!-- end row -->
        </div><!-- end container -->
    </div><!-- end section -->
    ...
    <section class="section nopad cac text-center">
        <a href="#">
            <h3>Nếu có bất kì thắc mắc nào cho ứng dụng của chúng tôi chỉ cần để lại liên hệ. Đội ngũ tư vấn của chúng tôi sẽ hỗ trợ tốt nhất!</h3>
        </a>
    </section>
